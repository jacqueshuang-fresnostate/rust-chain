...
const SERVER_PAGED_ENDPOINTS = new Set([
  ...
  '/admin/api/v1/earn/subscriptions',
  '/admin/api/v1/loan/orders',
  '/admin/api/v1/loan/products',
  '/admin/api/v1/margin/interest/summary',
  '/admin/api/v1/margin/liquidations',
  '/admin/api/v1/margin/positions',
  ...
  '/admin/api/v1/seconds-contracts/orders',
  '/admin/api/v1/seconds-contracts/products',
  '/admin/api/v1/spot/orders',
  '/admin/api/v1/spot/trades',
  '/admin/api/v1/users',
  '/admin/api/v1/wallet/accounts',
  '/admin/api/v1/wallet/deposits',
  '/admin/api/v1/wallet/ledger',
  '/admin/api/v1/wallet/withdrawals'
]);
