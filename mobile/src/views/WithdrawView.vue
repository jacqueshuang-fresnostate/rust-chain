      ...
      <template v-else>
        ...
        <template v-else-if="asset">
          <section class="withdraw-balance surface">
            ...
            <span class="withdraw-balance__links"><button type="button" @click="router.push({ name: 'withdrawal-records' })">{{ t('withdrawRecords.title') }}</button><button type="button" @click="router.push({ name: 'wallet-ledger' })">{{ t('assets.ledger') }}</button></span>
          </section>
