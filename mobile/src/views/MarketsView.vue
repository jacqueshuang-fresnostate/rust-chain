...
.market-category { border-bottom: 1px solid var(--line); display: flex; gap: 28px; }.market-category button { background: transparent; border-bottom: 2px solid transparent; color: var(--muted); font-size: 16px; min-height: 42px; padding: 0; }.market-category .is-active { border-color: var(--ink); color: var(--ink); font-weight: 750; }.market-error { align-items: center; background: #fdecec; border-radius: 6px; color: #b3261e; display: flex; font-size: 12px; gap: 10px; justify-content: space-between; margin: 12px 0 5px; padding: 7px 9px; }.market-error button { background: transparent; color: #b3261e; font-weight: 750; padding: 2px 4px; }
