...
test('杠杆为独立二栏下单、六卖七买真实盘口和真实持仓风险面', () => {
  ...
  assert.match(tradeSource, /resolveMarginPositionRiskMetrics\(\{[\s\S]*?serverMaintenanceMarginRate:[\s\S]*?productMaintenanceMarginRate:[\s\S]*?serverEstimatedLiquidationPrice:/)
