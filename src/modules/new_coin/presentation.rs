...
impl From<NewCoinProjectRead> for NewCoinProjectResponse {
    ...
    fn from(read: NewCoinProjectRead) -> Self {
        Self {
            ...
            quote_asset_symbol: read.quote_asset_symbol,
            quote_asset_logo_url: read.quote_asset_logo_url,
...
impl From<NewCoinSubscriptionRead> for NewCoinSubscriptionResponse {
    ...
    fn from(read: NewCoinSubscriptionRead) -> Self {
        Self {
            ...
            settlement_mode: read.settlement_mode,
            frozen_quote_amount: read.frozen_quote_amount,
            settled_quote_amount: read.settled_quote_amount,
            refunded_quote_amount: read.refunded_quote_amount,
