    ...
    modules::{
        admin::{
            application::{
                ...
                get_admin_new_coin_reconciliation as get_new_coin_reconciliation_use_case,
                ...
                list_admin_market_strategy_presets as list_market_strategy_presets_use_case,
                list_admin_market_strategy_recovery_jobs as list_market_strategy_recovery_jobs_use_case,
                list_admin_market_strategy_versions as list_market_strategy_versions_use_case,
                ...
                preview_admin_market_strategy as preview_market_strategy_use_case,
                ...
                restore_admin_market_strategy_version as restore_market_strategy_version_use_case,
            ...
            presentation::{
                ...
                MarketStrategyGapsResponse, MarketStrategyPresetsResponse,
                MarketStrategyPreviewResponse, MarketStrategyRecoveryJobResponse,
                MarketStrategyRecoveryJobsQuery, MarketStrategyRecoveryJobsResponse,
                MarketStrategyRecoveryPreviewResponse, MarketStrategyVersionsQuery,
                MarketStrategyVersionsResponse, NewCoinConvertRuleResponse,
                ...
                NewCoinPurchasesResponse, NewCoinReconciliationResponse,
                NewCoinSubscriptionsResponse, NewCoinUnlocksResponse,
                PreviewMarketStrategyRecoveryRequest, PreviewMarketStrategyRequest,
                ReclaimDepositAddressPoolRequest, ReloadMarketFeedRequest,
                ReloadMarketFeedResponse, ResetAgentPasswordRequest, ResetUserTwoFactorRequest,
                RestoreMarketStrategyVersionRequest, RiskEventsResponse, RiskRuleResponse,
                RiskRulesResponse, SaveMarketFeedConfigRequest, SaveSmtpConfigRequest,
...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .merge(financial_retries::routes())
        .merge(financial_reconciliation::routes())
