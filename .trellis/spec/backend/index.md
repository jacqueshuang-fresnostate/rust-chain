...
| [Market Favorites and Asset Logo Contract](./market-favorites.md) | Authenticated favorites, idempotency, user isolation, and backend-owned market/wallet logo metadata | Active |
