...
- Sync reads Polymarket Gamma `events` with `active=true`, `closed=false`, `limit=100`, and configured tags. Numeric tags use `tag_id`; non-numeric tags may use `tag_slug`.
